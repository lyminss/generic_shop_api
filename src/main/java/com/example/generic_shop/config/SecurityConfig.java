    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/vouchers/public").permitAll()
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/vouchers/validate").permitAll()
                        .requestMatchers("/api/vouchers/**").hasAnyRole("ADMIN", "STAFF")
                        .requestMatchers("/api/admin/**").hasAnyRole("ADMIN", "STAFF")
                        .requestMatchers("/api/category/**").hasAnyRole("ADMIN", "STAFF")
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/api/product/**").hasAnyRole("ADMIN", "STAFF")
                        .requestMatchers(org.springframework.http.HttpMethod.PUT, "/api/product/**").hasAnyRole("ADMIN", "STAFF")
                        .requestMatchers(org.springframework.http.HttpMethod.PATCH, "/api/product/**").hasAnyRole("ADMIN", "STAFF")
                        .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/api/product/**").hasAnyRole("ADMIN", "STAFF")
                        .requestMatchers("/api/ingredients/**", "/api/recipes/**", "/api/stock-receipts/**", "/api/stock-adjustments/**", "/api/inventory-transactions/**", "/api/inventory/**")
                            .hasAnyRole("ADMIN", "STAFF", "BARISTA")
